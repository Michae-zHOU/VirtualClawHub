        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-1 max-w-md mx-8 hidden md:block">
            <input 
              ...
              className="w-full rounded-full py-2 px-4 border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-400"
            />
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/cart" className="relative p-2 flex items-center text-slate-600 hover:text-slate-900 transition-colors">
              ...
              {itemCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center bg-green-600">
                  {itemCount}
                </span>
              )}
            </Link>
