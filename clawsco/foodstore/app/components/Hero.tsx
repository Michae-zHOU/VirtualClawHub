...
export default function Hero() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b min-h-[500px] flex items-center from-green-100 to-[#FFFBF0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight font-primary text-gray-900">
            Premium <span className="text-[#1B4332]">Quality</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/store" className="text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg bg-[#1B4332] hover:bg-green-800">
              Shop Now
            </Link>
            <button className="border px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg bg-white text-gray-900 border-green-50">
              Agent Protocol
            </button>
          </div>
        </div>
