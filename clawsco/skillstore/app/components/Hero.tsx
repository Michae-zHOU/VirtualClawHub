...
export default function Hero() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b min-h-[500px] flex items-center from-[#7C3AED]/20 to-[#0D1117]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight font-primary text-white">
            Premium <span className="text-[#7C3AED]">Quality</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/store" className="text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg bg-[#7C3AED] hover:bg-purple-600">
              Shop Now
            </Link>
            <button className="border px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg bg-[#161b22] text-white border-purple-900/30">
              Agent Protocol
            </button>
          </div>
        </div>
