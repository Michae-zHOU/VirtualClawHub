...
export default function Footer() {
  return (
    <footer className="border-t pt-16 pb-8 mt-auto bg-[#161b22] text-white border-purple-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center opacity-50 text-sm border-purple-900/30">
          <p>© {new Date().getFullYear()} Skill Store. All rights reserved.</p>
