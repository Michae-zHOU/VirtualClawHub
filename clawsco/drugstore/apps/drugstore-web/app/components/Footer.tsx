...
export default function Footer() {
  return (
    <footer className="border-t pt-16 pb-8 mt-auto bg-gray-100 text-gray-900 border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center opacity-50 text-sm border-gray-100">
          <p>© {new Date().getFullYear()} Drugstore. All rights reserved.</p>
