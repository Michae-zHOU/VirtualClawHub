    ...
    <div className="flex flex-col gap-20 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-2xl overflow-hidden border hover:shadow-xl transition-all duration-300 group bg-[#111111] border-gray-800">
              <div className="h-48 flex items-center justify-center text-6xl group-hover:scale-105 transition-transform duration-500 bg-[#1a1a1a]">
                🎨
              </div>
              <div className="p-6">
                ...
                <Link href="/store" className="font-medium hover:underline flex items-center gap-2 text-[#FF2D78]">
